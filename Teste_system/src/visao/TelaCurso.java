...
public class TelaCurso extends JPanel {
	...
	public TelaCurso() {
		...
		lblTituloCurso.setIcon(new ImageIcon(TelaCurso.class.getResource("/figuras/Notes.png")));
		...
		labelCargoCordenação.setFont(new Font("Tahoma", Font.PLAIN, 13));
		add(labelCargoCordenação, "cell 0 5,alignx right");
		...
		buttonLimparTela.setIcon(new ImageIcon(TelaCurso.class.getResource("/figuras/37263_monitor_erase_icon.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(TelaCurso.class.getResource("/figuras/Database.png")));
		...
		buttonCriarConcedente.setIcon(new ImageIcon(TelaCurso.class.getResource("/figuras/Create.png")));
		...
		butonLerConcedente.setIcon(new ImageIcon(TelaCurso.class.getResource("/figuras/List.png")));
		...
		buttonFazerUpConcedente.setIcon(new ImageIcon(TelaCurso.class.getResource("/figuras/Download.png")));
		...
		buttonRemoverConcedente.setIcon(new ImageIcon(TelaCurso.class.getResource("/figuras/Remove.png")));
