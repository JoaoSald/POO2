...
public class TelaConcedente extends JPanel {
	...
	public TelaConcedente() {
		...
		lblTituloConcedente.setIcon(new ImageIcon(TelaConcedente.class.getResource("/figuras/Company.png")));
		...
		labelRazãoSocial.setFont(new Font("Tahoma", Font.PLAIN, 13));
		add(labelRazãoSocial, "cell 0 5,alignx right,aligny center");
		labelRazãoSocial.setLabelFor(fieldRazaoSocial);
		...
		labelEndereço.setFont(new Font("Tahoma", Font.PLAIN, 13));
		add(labelEndereço, "cell 0 7,alignx right,aligny center");
		
		fieldEndereco = new JTextField();
		labelEndereço.setLabelFor(fieldEndereco);
		...
		buttonLimparTela.setIcon(new ImageIcon(TelaConcedente.class.getResource("/figuras/37263_monitor_erase_icon.png")));
		add(buttonLimparTela, "cell 3 10,alignx center,growy");
		
		JLabel lblNewLabel_1 = new JLabel("Opera\u00E7\u00F5es");
		lblNewLabel_1.setBackground(new Color(255, 255, 255));
		lblNewLabel_1.setIcon(new ImageIcon(TelaConcedente.class.getResource("/figuras/Database.png")));
		...
		buttonCriarConcedente.setIcon(new ImageIcon(TelaConcedente.class.getResource("/figuras/Create.png")));
		...
		butonLerConcedente.setIcon(new ImageIcon(TelaConcedente.class.getResource("/figuras/List.png")));
		...
		buttonFazerUpConcedente.setIcon(new ImageIcon(TelaConcedente.class.getResource("/figuras/Download.png")));
		...
		buttonRemoverConcedente.setIcon(new ImageIcon(TelaConcedente.class.getResource("/figuras/Remove.png")));
