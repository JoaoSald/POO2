...
public class TelaEstagiario extends JPanel {
	...
	public TelaEstagiario() {
		...
		lblTituloCurso.setIcon(new ImageIcon(TelaEstagiario.class.getResource("/figuras/User group.png")));
		...
		labelEndreço.setFont(new Font("Tahoma", Font.PLAIN, 13));
		add(labelEndreço, "flowx,cell 0 6,alignx right,aligny center");
		...
		buttonLimparTela.setIcon(new ImageIcon(TelaEstagiario.class.getResource("/figuras/37263_monitor_erase_icon.png")));
		...
		laberOperacoes.setIcon(new ImageIcon(TelaEstagiario.class.getResource("/figuras/Database.png")));
		...
		buttonCriarEstagiario.setIcon(new ImageIcon(TelaEstagiario.class.getResource("/figuras/Create.png")));
		...
		butonLerEstagiario.setIcon(new ImageIcon(TelaEstagiario.class.getResource("/figuras/List.png")));
		...
		buttonFazerUpEstagiario.setIcon(new ImageIcon(TelaEstagiario.class.getResource("/figuras/Download.png")));
		...
		buttonRemoverEstagiario.setIcon(new ImageIcon(TelaEstagiario.class.getResource("/figuras/Remove.png")));
